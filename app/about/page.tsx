      ...
      <main className="flex-grow container mx-auto p-8">
        ...
        <div className="bg-gray-800 p-8 rounded-lg">
          ...
          <p className="text-gray-300 mb-4">
            ...
            better understand the plants around me. When I found it difficult to
            identify and learn about them, I decided to develop this app to help
            myself and others who share the same curiosity and love for nature.
          </p>
          <p className="text-gray-300">
